...
class SqlAlchemyMallRepository:
    ...
    def _sync_default_zones(self) -> None:
        ...
        defaults = {
            ...
            "grains": {"name": "精品杂粮", "zone_type": "category", "icon": "🌾", "match_tag": None, "sort_order": 11},
            "vegetables": {"name": "蔬菜菌菇", "zone_type": "category", "icon": "🥬", "match_tag": None, "sort_order": 12},
            "meat_eggs": {"name": "肉禽蛋", "zone_type": "category", "icon": "🥩", "match_tag": None, "sort_order": 13},
            "soy_products": {"name": "豆制品", "zone_type": "category", "icon": "🫘", "match_tag": None, "sort_order": 14},
            "fruits": {"name": "水果鲜食", "zone_type": "category", "icon": "🍎", "match_tag": None, "sort_order": 15},
            "oil": {"name": "健康好油", "zone_type": "category", "icon": "🫒", "match_tag": None, "sort_order": 16},
            "seasoning": {"name": "调味酱料", "zone_type": "category", "icon": "🧴", "match_tag": None, "sort_order": 17},
            "dairy": {"name": "乳制品", "zone_type": "category", "icon": "🥛", "match_tag": None, "sort_order": 18},
            "beverages": {"name": "健康饮品", "zone_type": "category", "icon": "🥤", "match_tag": None, "sort_order": 19},
            "snacks": {"name": "健康零食", "zone_type": "category", "icon": "🍪", "match_tag": None, "sort_order": 20},
            "wine_tea": {"name": "红酒茶叶", "zone_type": "category", "icon": "🍷", "match_tag": None, "sort_order": 21},
        }
    ...
    def _seed_zones(self) -> None:
        zones = [
            ...
            MallZone(zone_code="grains", name="精品杂粮", zone_type="category", icon="🌾", match_tag=None, sort_order=11),
            MallZone(zone_code="vegetables", name="蔬菜菌菇", zone_type="category", icon="🥬", match_tag=None, sort_order=12),
            MallZone(zone_code="meat_eggs", name="肉禽蛋", zone_type="category", icon="🥩", match_tag=None, sort_order=13),
            MallZone(zone_code="soy_products", name="豆制品", zone_type="category", icon="🫘", match_tag=None, sort_order=14),
            MallZone(zone_code="fruits", name="水果鲜食", zone_type="category", icon="🍎", match_tag=None, sort_order=15),
            MallZone(zone_code="oil", name="健康好油", zone_type="category", icon="🫒", match_tag=None, sort_order=16),
            MallZone(zone_code="seasoning", name="调味酱料", zone_type="category", icon="🧴", match_tag=None, sort_order=17),
            MallZone(zone_code="dairy", name="乳制品", zone_type="category", icon="🥛", match_tag=None, sort_order=18),
            MallZone(zone_code="beverages", name="健康饮品", zone_type="category", icon="🥤", match_tag=None, sort_order=19),
            MallZone(zone_code="snacks", name="健康零食", zone_type="category", icon="🍪", match_tag=None, sort_order=20),
            MallZone(zone_code="wine_tea", name="红酒茶叶", zone_type="category", icon="🍷", match_tag=None, sort_order=21),
        ]
        for zone in zones:
            self.db.add(zone)
